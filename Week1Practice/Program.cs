...
namespace Week1Practice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<string> productsList = new List<string>() { "basketball", "baseball glove", "tenns shoes", "hockey puck" }
;
            ...
            Console.WriteLine("My product list has " + listLength + " items in it.");
